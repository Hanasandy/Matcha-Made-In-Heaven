    ...
    return (
      <div>
        <Menu onClick={this.handleClick} selectedKeys={[this.state.current]} mode="horizontal" className="menu">
           ...
           <Menu.Item key="Contact"><a href="#/Contact"><Icon type="phone" />Contact Us</a></Menu.Item>

           <Menu.Item key="alipay"> <a href="/login" target="_blank" rel="noopener noreferrer">Register/Login</a></Menu.Item>

           <Menu.Item key="Cart"><a href="#/Cart"  >Cart</a></Menu.Item>
